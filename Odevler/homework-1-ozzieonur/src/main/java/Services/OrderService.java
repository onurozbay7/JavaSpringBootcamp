...
public class OrderService {
    ...
    public void getAllOrders() {
        ...
        orderList.stream().map(c -> " | Müşteri: " + CustomerService.getCustomerNameById(c.getCustomerId()) + " | Tutar: " + c.getTotalAmount())
                .forEach(System.out::println);
    }

    public void getSumAmount(String month) {
        List<Customer> list = CustomerService.getFilteredCustomersByMonth(month);
    ...
    public void getOrdersFromOneCustomer(Customer customer) {
