...
public class Company {
    ...
    public Map<Customer, List<Order>> oneCompanyMap = new HashMap<>();
    ...
    public Map<Customer, List<Order>> getOneCompanyMap() {
        return oneCompanyMap;
    }

    public void setOneCompanyMap(Map<Customer, List<Order>> oneCompanyMap) {
